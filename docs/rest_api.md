...
| DELETE | `/:id`             | 🔑 `roles.edit` | **الحذف الوحيد بالمشروع** — مسموح فقط إن لم يُشِر إليه أي تعيين **قط**. «لا أحد يحمله الآن» ليس الشرط (ذاك هو التعطيل). `409 role_has_history` أو `403 role_system_default_undeletable` |
